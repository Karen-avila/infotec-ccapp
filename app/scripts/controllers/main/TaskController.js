(function (module) {
    mifosX.controllers = _.extend(module, {
        TaskController: function (scope,$rootScope, resourceFactory, route, dateFilter, $uibModal, location, translate, MIN_DATEPICKER, MAX_DATEPICKER,SIGNATUREURL, $http) {
            scope.clients = [];
            scope.loans = [];
            scope.offices = [];
    ...
    mifosX.ng.application.controller('TaskController', ['$scope','$rootScope', 'ResourceFactory', '$route', 'dateFilter', '$uibModal', '$location', '$translate', 'MIN_DATEPICKER', 'MAX_DATEPICKER','SIGNATUREURL','$http', mifosX.controllers.TaskController]).run(function ($log) {
