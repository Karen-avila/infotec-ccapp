    ...
    mifosX.controllers = _.extend(module, {
        ClientController: function (scope, resourceFactory, location) {
            ...
            scope.search = function () {
                ...
                var searchResource = "clients,clientIdentifiers";
                if (n != 0) {
                    exactMatch = true;
                }

                var emailRegExp = /\S+@\S+\.\S+/;
                if (emailRegExp.test(searchString)) {
                    searchString = searchString.toLowerCase();
                    searchResource = "clients";
                } else {
                ...
                if (!scope.searchText) {
                    ...
                    resourceFactory.globalSearch.search({ query: searchString, resource: searchResource, exactMatch: exactMatch },
                        function (data) {
