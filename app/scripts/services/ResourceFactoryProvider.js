        ...
        ResourceFactoryProvider: function () {
            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                    ...
                    clientDuplicatesResource: defineResource(apiVer + "/clients/duplicates", {}, {
                        duplicates: { method: 'POST', params: {} }
                    }),
                    ...
                    codeOptionsResource: defineResource(apiVer + "/codes/:codeName/options", { codeName: '@codeName' }, {
                        get: { method: 'GET', params: {} }
                    }),
                    ...
                    savingsFundResource: defineResource(apiVer + "/savingsaccounts/fundAccounts", {}, {
                        get: { method: 'GET', params: {}, isArray: true }
                    }),
